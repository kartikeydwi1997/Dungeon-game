 ...
 */
public class MainView extends JFrame implements DungeonView {
  JMenuBar menuBar;
  JMenu menu;
  JMenuItem menuItem;
    ...
    menuItem.addMouseListener(new MouseAdapter() {
      ...
      private void callSettings() throws IOException {
        ...
        if (result == JOptionPane.OK_OPTION) {
          if (Objects.equals(rows.getText(), "") || Integer.parseInt(rows.getText()) < 0) {
            invalidValues = true;
            JOptionPane.showMessageDialog(null,
                    "Invalid Row value entered!");
          }
          if (Objects.equals(cols.getText(), "") || Integer.parseInt(cols.getText()) < 0) {
            invalidValues = true;
            JOptionPane.showMessageDialog(null,
                    "Invalid Column value entered!");
          }
          if (Objects.equals(connectivity.getText(), "")) {
            invalidValues = true;
            JOptionPane.showMessageDialog(null,
                    "Invalid connectivity value entered!");
          }
          if (Objects.equals(treasurePerct.getText(), "")
                  || Integer.parseInt(treasurePerct.getText()) < 0
                  || Integer.parseInt(treasurePerct.getText()) > 100) {
            invalidValues = true;
            JOptionPane.showMessageDialog(null,
                    "Invalid Treasure Percentage value entered!");
          }
          if (Objects.equals(monsterCount.getText(), "")
                  || Integer.parseInt(monsterCount.getText()) < 0
                  || Integer.parseInt(monsterCount.getText()) > 100) {
            invalidValues = true;
            JOptionPane.showMessageDialog(null,
  ...
  public void addKeyListener(GameInterface controller) {
    this.addKeyListener(new MyKeyListener(controller));
